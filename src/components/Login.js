  ...
  handleClick(event){
    ...
    if(response.status == 200){
      console.log("valid pin ");
        console.log(response,"responseeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
    //  var uploadScreen=[];
